      ...
      <header className="relative flex items-center justify-between px-4 py-2 bg-surface/80 backdrop-blur-lg border-b border-white/5 shrink-0 gap-2">
        ...
        <div className="flex items-center gap-1.5 lg:gap-2">
          ...
          <div className="relative" ref={shareRef}>
            ...
            {showShareMenu && (
              <div className="absolute right-0 top-full mt-1 bg-surface-high border border-white/10 rounded-xl shadow-xl overflow-hidden z-50 min-w-44">
                <button
                  onClick={() => { setShowShareMenu(false); window.location.href = `https://wa.me/?text=${shareText}%20${shareUrl}` }}
                  className="flex items-center gap-3 w-full px-3 py-2.5 hover:bg-surface-highest transition-colors text-sm text-on-surface cursor-pointer"
                >
